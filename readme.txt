=== CMS2CMS: Ektron to WordPress Migration  ===
Contributors: cms2cms
Tags: Ektron to WordPress, Ektron to WordPress migration, convert Ektron to WordPress, migrate Ektron to WordPress, images, plugin
...
If you wish to make the first step on the way towards your current Ektron web project improvement - CMS2CMS: Migration Plugin can assist you.
...
= *There is Free Demo available (migration of limited number of pages, user, comment. etc.)* =
...
1. Go to Admin -> Plugins, find “Ektron to WordPress Migration” and click Activate.
